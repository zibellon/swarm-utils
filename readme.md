...
13. Labels. Добавить labels для указания creds от S3. куда заливать бжкапы каждого сервиса
    1.  На данный момент - используются общие кредс на весь кластер (Через ENV)
14. Добавит маскировку inpupCommand для bashExec
    1.  Когда производится команда - docker login -> все данные вижны в консоль...
