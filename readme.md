...
4. update-service
   ...
   3. Параметры API запроса
      ...
      4. isRegistryAuth - необязательный параметр. true/false
         1. На данный момент - зависит от ENV переменных SWARM_UTILS_REGISTRY_*
      5. isForce - необязательный параметр. Обновляем FORCE или нет
